...
await build({
  entryPoints: [new URL('../src/meridian-consent-analytics.js', import.meta.url).pathname],
  outfile: new URL('../dist/meridian-consent-analytics.min.js', import.meta.url).pathname,
  bundle: false,
  minify: true,
  legalComments: 'none',
  target: ['es2020'],
...
await copyFile(
  new URL('../src/meridian-consent-analytics.js', import.meta.url),
  new URL('../dist/meridian-consent-analytics.js', import.meta.url),
);
